...
@interface WMPlaceholderTextView()
/**标签*/
...
- (void)updatePlaceholderFontSize{
    ...
    frame.size = [self.placeholder boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:self.font} context:nil].size;
